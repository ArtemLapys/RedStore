...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        def createTable():
          data = None
          png = QtCore.QFile(":/mainWindow/imageRedStore/settings.png")
          if (png.open(QtCore.QIODevice.ReadOnly)):
            data = png.readAll()
            png.close()
          cur = self.con.cursor()
          ...
          for i in range(MAX_COUNT):
            insertTuple = (i, "Apppppp pppppp"+str(i), data)
            cur.execute("INSERT INTO Apps (id, AppName, Image) VALUES (?, ?, ?);", insertTuple)
...
"background-color:#F0F0F0;")
        ...
        ###крайне осторожно- рекурсивный вызов!!!
        def initSearch(text):
